...
model_save_path = "derma.h5"  # Specify the path to save the trained model
...
num_classes = 25  # Number of classes in your dataset
model.add(Dense(num_classes, activation='softmax'))  # Change the number of units and activation function
...
model_save_path = "derma.h5"  # Change the model file name
